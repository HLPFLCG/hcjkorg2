        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 lg:gap-16">
          ...
          <div className="flex flex-col items-center md:items-start">
            <Image
              ...
              className="mb-6"
            />
            <h3 className="font-playfair text-2xl font-bold text-black text-center md:text-left">
              HCJK Collection
            </h3>
          </div>
          ...
          <div>
            ...
            <ul className="font-lato space-y-3 text-lg">
              {[
                'Wedding Photography',
          ...
          <div>
            ...
            <ul className="font-lato space-y-3 text-lg">
              {[
                ...
                <li key={link.href}>
                  <Link href={link.href} className="text-gray-700 hover:text-merlot transition-colors">
                    {link.label}
                  </Link>
                </li>
              ))}
            ...
            <ul className="font-lato space-y-4 text-lg">
              <li>
                <a
                  ...
                  className="flex items-center gap-3 text-gray-700 hover:text-merlot transition-colors group"
                >
                  <svg className="w-6 h-6 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                  </svg>
                  <span>contact@hcjk.org</span>
                </a>
              </li>
              <li>
                <a
