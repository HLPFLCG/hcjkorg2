    ...
    <section className="section bg-[#faf0e6] border-t-4 border-merlot py-32">
      <div className="container max-w-[1800px]">
        <div className="text-center mb-20">
          ...
          <p className="text-2xl md:text-3xl text-gray-700 max-w-4xl mx-auto leading-relaxed mb-6">
          ...
          <a
            ...
            className="inline-flex items-center gap-3 text-merlot hover:text-merlot-dark font-lato font-semibold text-2xl transition-colors group"
          >
            <svg className="w-8 h-8 transform group-hover:scale-110 transition-transform" fill="currentColor" viewBox="0 0 24 24">
        ...
        {/* Much Larger Instagram Feed Container */}
        <div className="w-full bg-white p-8 rounded-lg shadow-strong">
          <div 
